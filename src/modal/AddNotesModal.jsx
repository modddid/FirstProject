...
export default function AddNotesModal() {
  ...
  return (
    <div>
    <div
      className="fixed inset-0 bg-black opacity-[0.3] z-10"
    ...
    >
      <div className="mb-6 bg-[#444444] p-6 rounded-md">
        ...
        <div>
          ...
          <input
            ...
            name="title"
            id="Note Title"
            className="mb-4 rounded px-3 h-10 bg-[#2a2a2a] outline-none border-transparent border-[1px] hover:border-[#d4af37] hover:border-[1px] hover:border-solid transition"
        ...
        <button className="w-full bg-[#d4af37] text-white py-2 rounded-md hover:bg-[#b88c2e] transition-all">
          AddNote
        </button>
      </div>
    </form>
