...
export default function UpdateFormModal({ showUpdateModal }) {
  ...
  >
    <div>
      <label htmlFor="NoteTitle" className="block mb-2 text-sm font-medium text-gray-200">
        Note Title
      </label>
      <input
        type="text"
        ...
        className="mb-4 rounded px-3 h-10 bg-[#1a1a1a] text-gray-100 outline-none border-transparent border-[1px] hover:border-[#d4af37] transition"
    ...
    <button
      className="w-full bg-[#d4af37] text-gray-100 py-3 rounded-lg font-bold hover:bg-[#b88c2e] transition-all duration-300 shadow-lg "
    >
      Save
    </button>
  </form>
